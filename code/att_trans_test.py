...
class ACG(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(2*300+26,h1l)
...
filename="./data/d2_site_bia40_test.xlsx"
...
net_acg = torch.load('att_modelss2.pkl')
if cuda:
    restore_net = net_acg.cuda()
net_acg.eval()
#fc=ACG()
...
optimizer = torch.optim.SGD(fc.parameters(), lr=lr, momentum=0.9, weight_decay=1e-4)
loss_history = []
...
for epoch in range(num_epoch):
    ...
    print("----------------------------------------")
#torch.save(net_acg, 'att_model.pkl')