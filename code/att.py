...
class BiLSTM_Attention(nn.Module):
    ...
    def __init__(self,  embedding_dim=256, hidden_dim=200, n_layers=2):
...
#     list2=[]
#     for t in range(255):
#         list2.append(data_train[i][t+1]-data_train[i][t])
#     list2.append(0)    
#     list1.append(list2)
# np1=np.array(list1)
# data_train=np.concatenate((np1,data_train[:,256:]),axis=1)
